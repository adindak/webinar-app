...
<x-app-layout>
    ...
    <div class="flex justify-between items-center flex-wrap gap-4 mb-6">
        <h1 class="text-3xl font-bold text-white drop-shadow-lg">Event History</h1>
    ...
    <div class="bg-white/95 glass-effect border border-white/20 rounded-2xl shadow-xl backdrop-blur-sm mb-6 min-h-[600px]">
        ...
        <div class="p-6 border-b border-gray-200/50">
            <div class="flex justify-between items-center flex-wrap gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Riwayat Event</h2>
                    <p class="text-gray-600 mt-1">Event yang telah Anda ikuti sebelumnya</p>
                </div>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($webinars as $webinar)
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group relative">
                        <!-- Completed Badge -->
                        ...
                        <div class="relative overflow-hidden">
                            <a href="{{ route('events.history-detail', ['id' => $webinar->id]) }}" class="block">
                                <img src="{{ asset('') }}assets/images/event-2.jpg" 
                                     class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" 
                                     alt="{{ $webinar->name }}">
                            </a>
                            
                            <!-- Overlay with completion info -->
                                ...
                                <div class="absolute bottom-4 left-4 right-4">
                                    <div class="flex items-center justify-between text-white text-sm">
                                        ...
                                        <span class="flex items-center">
                                            ...
                                            {{ \Carbon\Carbon::parse($webinar->start_date)->diffForHumans() }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="absolute top-3 right-3">
                                ...
                                @else
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-purple-100 text-purple-800 shadow-sm">
                                        <i class="fas fa-star mr-1.5"></i>Premium
                                    </span>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-100 pt-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="{{ route('events.history-detail', ['id' => $webinar->id]) }}" 
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-500 flex items-center">
                                        ...
                                        {{ $webinar->total_participants ?? 0 }} peserta
                                    </span>
                ...
                @empty
                    ...
                    <div class="col-span-full">
                        <div class="text-center py-12">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">Belum ada riwayat event</h3>
                            <p class="text-gray-600 max-w-md mx-auto mb-6">
                                Anda belum mengikuti event apapun. Mulai daftarkan diri Anda ke event-event menarik.
                            </p>
                            <a href="{{ route('events.index') }}" 
                               class="inline-flex items-center bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5">
            ...
            <div class="mt-8 flex justify-between items-center border-t border-gray-200/50 pt-6">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold">{{ $webinars->count() }}</span> dari <span class="font-semibold">{{ $webinars->count() }}</span> event selesai
                </div>
                <div class="text-sm text-gray-500">
                    Total: {{ $webinars->count() }} event telah diikuti
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const searchInput = document.querySelector('input[placeholder="Cari riwayat event..."]');
            if (searchInput) {
                searchInput.addEventListener('input', function(e) {
                    // Add search logic here
                    console.log('Searching history for:', e.target.value);
                });
            }
            ...
            selects.forEach(select => {
                select.addEventListener('change', function(e) {
                    ...
                    console.log('History filter changed:', e.target.value);
                });
            });
        });
    </script>
